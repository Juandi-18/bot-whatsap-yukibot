...
export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    try {
      ...
      if (!mediaList.length) return m.reply(`ꕥ No se encontraron videos para ${character.name}.`);
      ...
      return await client.sendMessage(m.chat, { video: buffer, caption: msg }, { quoted: m });
    } catch (e) {
